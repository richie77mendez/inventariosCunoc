...
public class TarjetaAux {
    ...
    public TarjetaAux(String DPI, String codigoCorrelativo, String division, String modulo, String salon, Date fechaImpresion, String estado) {
        this.DPI = DPI;
